...
class ResilientChatModel(ChatOpenAI):
    ...
    def _is_rate_limit(self, e: Exception) -> bool:
        """Detect Vercel AI Gateway 429 rate-limit errors."""
        msg = str(e).lower()
...
# Model: resolved from Supabase agent_settings at startup (main_agent_provider / main_agent_model)
# Falls back to AI_GATEWAY_API_KEY env var and xiaomi/mimo-v2.5-pro if not configured.
