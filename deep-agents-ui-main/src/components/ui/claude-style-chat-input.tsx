                        ...
                        <div className="flex flex-row items-center min-w-0 gap-1">
                            {onStartAgent && (
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-1.5 h-8 rounded-xl px-3 text-xs font-semibold bg-primary text-primary-foreground hover:bg-primary/95 transition-all duration-200 active:scale-95 shadow-sm shrink-0"
                                    type="button"
                                    title="Start Agent Pipeline"
                                >
