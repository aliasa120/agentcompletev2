...
const Logo: FC = () => {
  return (
    <div className="flex items-center gap-2 px-2 text-sm font-medium">
      ...
      <span className="text-foreground/90 font-serif">deepagents</span>
    </div>
  );
};
...
export const Thread: FC<{ onStartAgent?: () => void }> = ({ onStartAgent }) => {
    ...
    >
      ...
      >
        ...
        <ThreadPrimitive.ViewportFooter
          className={cn(
            "aui-thread-viewport-footer bg-background mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 overflow-visible pb-4 md:pb-6",
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mx-auto mb-6 flex w-full max-w-[var(--thread-max-width)] flex-col items-center px-4 text-center">
      ...
      <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
        <ComposerPrimitive.AttachmentDropzone asChild>
          ...
          >
            ...
            />
            <ComposerAction onStartAgent={onStartAgent} />
          </div>
...
const AutoCollapsibleToolGroup: FC<{
  part: any;
...
const AssistantMessage: FC = () => {
  ...
  return (
    <MessagePrimitive.Root
      ...
      data-role="assistant"
      className="fade-in slide-in-from-bottom-1 animate-in relative mx-auto w-full max-w-[var(--thread-max-width)] duration-150"
    >
      <div
      ...
      <div
        ...
        className="ml-2 flex items-center pt-1.5"
        style={{ marginBottom: "-38px", minHeight: "38px" }}
      >
        <BranchPicker />
        <AssistantActionBar />
      </div>
...
const UserMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      ...
      data-role="user"
      className="fade-in slide-in-from-bottom-1 animate-in mx-auto grid w-full max-w-[var(--thread-max-width)] auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] content-start gap-y-2 px-2 duration-150 [&:where(>*)]:col-start-2"
    >
      <UserMessageAttachments />

      <div className="aui-user-message-content-wrapper group relative col-start-2 min-w-0">
...
const UserActionBar: FC = () => {
  return (
    <ActionBarPrimitive.Root
      hideWhenRunning
      autohide="not-last"
      className="aui-user-action-bar-root flex flex-col items-end opacity-0 group-hover:opacity-100 transition-opacity duration-200"
    >
...
const EditComposer: FC = () => {
  return (
    <MessagePrimitive.Root
      ...
      className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col px-2"
    >
      <ComposerPrimitive.Unstable_TriggerPopoverRoot>
        <ComposerPrimitive.Root className="aui-edit-composer-root border-border/60 dark:border-muted-foreground/15 ml-auto flex w-full max-w-[85%] flex-col rounded-[var(--composer-radius)] border bg-[var(--composer-bg)] shadow-[0_4px_16px_-8px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.04)] dark:shadow-none">
          <LexicalComposerInput
            directiveChip={DirectiveChip}
            autoFocus
