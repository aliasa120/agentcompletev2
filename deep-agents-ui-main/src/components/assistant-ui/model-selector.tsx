...
function ModelSelectorValue({
  ...
  return (
    ...
    >
      ...
      {effortName && (
        <span className="text-muted-foreground min-w-[1.875rem] truncate text-center">
          {effortName}
        </span>
      )}
    </span>
...
function ModelSelectorContent({
  ...
  return (
    <PopoverContent
      ...
      className={cn(
        "bg-popover/95 w-72 min-w-[var(--radix-popover-trigger-width)] overflow-hidden rounded-xl p-0 shadow-lg backdrop-blur-sm",
        className,
      )}
      {...props}
    >
