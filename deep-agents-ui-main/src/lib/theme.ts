...
export const tw = {
  ...
  bg: {
    ...
    successSubtle:    "bg-emerald-50 dark:bg-emerald-950/30",
    warningSubtle:    "bg-amber-50 dark:bg-amber-950/30",
  ...
  border: {
    ...
    successSubtle:    "border-emerald-200 dark:border-emerald-800",
    warningSubtle:    "border-amber-200 dark:border-amber-800",
  },
  badge: {
    ...
    success:    "bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-400",
    warning:    "bg-amber-50 text-amber-700 border border-amber-200 dark:bg-amber-950/30 dark:text-amber-400",
