        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <header className="sticky top-0 z-10 border-b border-border bg-card/95 backdrop-blur-md shadow-sm">
                <div className="mx-auto flex max-w-5xl items-center gap-3 px-4 py-3 flex-wrap">
                    <Link href="/"><Button variant="ghost" size="sm" className="gap-2 text-muted-foreground hover:text-foreground"><ArrowLeft size={16} />Back</Button></Link>
                    <div className="h-5 w-px bg-border" />
                    <h1 className="text-[15px] font-bold text-foreground shrink-0">Social Media Posts</h1>
                    <span className="text-[13px] text-muted-foreground shrink-0">({posts.length} stories)</span>
                    ...
                    <div className="flex items-center gap-2 ml-auto shrink-0">
                        ...
                        <Link href="/posts/settings">
                            <Button variant="outline" size="sm" className="gap-1.5 text-muted-foreground hover:text-foreground text-[13px]">
                                <Settings size={13} />Settings
                            </Button>
                        </Link>
                        <Button variant="outline" size="sm" onClick={fetchPosts} disabled={loading} className="gap-1.5 text-muted-foreground hover:text-foreground text-[13px]">
