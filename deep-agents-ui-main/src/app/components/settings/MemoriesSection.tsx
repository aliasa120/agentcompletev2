        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full sm:w-72 h-10 rounded-lg border border-input bg-background px-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary"
            >
              {workflows.length === 0 ? (
          ...
          <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
            <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                className="w-20 h-7 rounded border bg-background px-2 text-xs font-mono text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
              />
              <span>chars</span>
            </div>
            <div className="flex items-center gap-1.5">
        ...
        {activeTab !== "HONCHO" && (
          <div className="space-y-3 pt-2">
            ...
            <textarea
              ...
              className="w-full h-80 rounded-lg border border-input bg-background p-4 font-mono text-xs leading-relaxed focus:outline-none focus:ring-2 focus:ring-primary shadow-inner"
            />
          </div>
        )}
        ...
        {activeTab === "HONCHO" && (
          <div className="p-4 sm:p-5 rounded-lg border bg-muted/10 space-y-4">
            <div className="flex items-center justify-between border-b pb-3">
              ...
              <span className={`px-2.5 py-1 rounded-full text-xs font-medium flex items-center gap-1.5 ${honchoStatus?.configured ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20" : "bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20"}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1 p-3 rounded-md bg-card border">
                ...
                <p className="font-mono text-foreground">{honchoStatus?.api_url || "Not set"}</p>
              </div>
              <div className="space-y-1 p-3 rounded-md bg-card border">
                <p className="font-semibold text-muted-foreground">Workspace Name</p>
                <p className="font-mono text-foreground">{honchoStatus?.workspace || "default_workspace"}</p>
              </div>
            </div>

            <div className="p-3.5 rounded-lg border bg-card text-xs space-y-2">
