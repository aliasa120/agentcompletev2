...
const BUILTIN_TOOLS = [
  ...
  { key: "save_tiktok_post", label: "Save TikTok Video", desc: "Saves TikTok short-form video drafts for Buffer publishing", pluginBadge: "Posts Plugin" },
  { key: "save_pinterest_post", label: "Save Pinterest Pin", desc: "Saves Pinterest pins with boards and images for Composio publishing", pluginBadge: "Posts Plugin" },
  ...
  { key: "add_to_desk", label: "Add to Desk", desc: "Deposit task cards on the user's Desk for one-click review & execution" },
