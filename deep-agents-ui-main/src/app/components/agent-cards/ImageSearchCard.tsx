...
export const ImageSearchCard = React.memo<{ toolCall: ToolCall; variant?: "fetch" | "score" }>(
    ...
    return (
      ...
      >
        <QueryChip accentColor={ACCENT}>
          <TypewriterText text={phase === "querying" ? displayText : query} isDone={phase !== "querying" || isDone} accentColor={ACCENT} />
        </QueryChip>
